...
.post(upload.single('image'), async (req, res) => {
  // try {
  //   const result = await dbcol.insertMany(testdata);
  ...
  // TODO: how to specify a query mongodb in chrome
})
...
.get( async (req, res) => {
  const tosearch = req.query.productname;
  try {
...
.patch( async (req, res) => {
  ...
  const update = {$set: {website: req.query.newsite}};
  try {
